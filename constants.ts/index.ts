...
export const WORK_EXPERIENCE = [
  {
    ...
    description: `
      ...
      Currently contributing to the front-end development of the DeXter-on-Radix open source project.`,
...

  {
    ...
    description:
      "Research Associate at UBC (Vancouver, BC) & INSERM (french NIH, France). Conducted R&D in academic laboratories, data analysis, student mentoring, collaboration within international teams resulting in three peer-reviewed publications.",
    className: "md:col-span-2",
    thumbnail: "/exp3.png",
